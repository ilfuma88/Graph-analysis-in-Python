from structures.graphPack.Graph import GraphBase
from structures.graphPack.Base import Edge, Node
from structures.listPack.DoubleLinkedList import ListaDoppiamenteCollegata as List
...
class GraphAdjacencyList(GraphBase):
    ...
    that exis
        ...
        del self.nodes[ts an edges (u,v).
    ---
    ...
    def addNode(self, elem):
        ...
        self.nodes[newnode.id] = newnode.value
...
if __name__ == "__main__":
    ...
    graph.insertEdge(4,11)
    graph.insertEdge(11,4)
    graph.insertEdge(9,13)
    graph.insertEdge(13,9)
