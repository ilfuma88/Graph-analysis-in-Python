from structures.treePack.binaryTree import BinaryTree
from structures.treePack.binaryTree import BinaryNode
from structures.treePack.dictBinaryTree import DictBinaryTree
...
class DictAVL(DictBinaryTree):
    ...
    def maxKeyTree(self):
        """Permette di trovare il nodo massimo dell'albero"""
        maxy=self.maxKeySon(self.tree.root)
        return maxy
# Balancing
